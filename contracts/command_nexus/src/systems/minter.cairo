...
mod minter {
    ...
    // https://github.com/dojoengine/dojo/blob/328004d65bbbf7692c26f030b75fa95b7947841d/examples/spawn-and-move/manifests/dev/overlays/command_nexus/dojo_examples_others_others.toml
    ...
    //
    #[abi(embed_v0)]
    impl MinterImpl of IMinter<command_nexustate> {
        fn mint(ref world: IWorldDispatcher, to: ContractAddress, token_contract_address: ContractAddress) -> u128 {
    ...
    impl InternalImpl of super::IMinterInternal<command_nexustate> {
        #[inline(always)]
        fn assert_caller_is_owner(world: @IWorldDispatcher) {
